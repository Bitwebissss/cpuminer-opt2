...
#ifdef USE_GPU
"\
      --use-gpu=CUDA|OPENCL  use GPU mining (argon2id1024 only)\n\
      --gpu-id=N[,N]    use specific GPU device(s) by index\n\
      --gpu-batchsize=N set GPU batch size (default: 1, recommend 64+)\n\
"  
#endif
"\
